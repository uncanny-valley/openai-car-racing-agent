...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--env', default=0, help='The environment version (CarRacing-v0 or CarRacing-v1)')    parser.add_argument('-o', '--output-file', required=True, help='Name of the .npy file to output the dataset')
