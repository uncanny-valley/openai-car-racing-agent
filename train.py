...
def main():
    ...
    parser.add_argument('-n', '--num_episodes', type=int, default=500, help='The number of episodes with which to train the agent')
    ...
    parser.add_argument('-s', '--replay-buffer-size', type=int, default=5000, help='The size of the experience replay memory buffer')
    parser.add_argument('-b', '--minibatch-size', type=int, default=64, help='The size of the minibatch that we will use to intermittently train the agent')
    ...
    parser.add_argument('-u', '--update-frequency', type=np.int64, default=5, help='How often to update the target model\'s weights')
